...
/*
 * STYLELINT Configuration file from bootstrap
 * https://github.com/twbs/stylelint-config-twbs-bootstrap/blob/main/index.js
 * 
 * Adapted and extended to add "stylelint-no-unsupported-browser-features"
 */
module.exports = {
  'extends': [
